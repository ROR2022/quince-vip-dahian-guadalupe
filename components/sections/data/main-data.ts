export const quinceMainData = {
  ...
  event: {
    celebrant: "Dahian Guadalupe",
      parents: {
      father: "Oscar Jesús Macías Ramirez",
      mother: "Griselda Aramina Patiño Vázquez",
  ...
  dressCode:{
    ...
    subtitle: "Código de vestimenta formal - Dorado y Rosa expclusivo para la quinceañera",
